...
import I3_1_L.db.DAO_Person_Interface;
...
public class PersonenListe extends PersonAbstractTableModel {
    ...
    private DAO_Person_Interface dataBase;
     ...
     */
    public PersonenListe(DAO_Person_Interface dataBase) {
        this.dataBase = dataBase;
        personList = dataBase.selectAll();
        if (personList == null)
    ...
    public void removePerson(int index) {
        this.dataBase.removePerson(personList.get(index));
