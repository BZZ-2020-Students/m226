...
public class Customer{
  ...
  */
  ...
  <p>Ist das Buch verf�gbar, wird die Referenz abgespeichert.<br>
  ...
  */
  public void borrow_aBookByTitle(String title){
    ...
    //
    //    +-----------------------------------------------------------------+
    //    | Gib Bibliothekar den gew�nschten Buchtitel                      �
    //    +-----------------------------------------------------------------+
    //    � if (keine g�ltige Buchreferenez)                                �
    //    �    --+----------------------------------------------------------+
  ...
  /**
  Bringt dem Bibliothekar das ausgeliehene Buch zur�ck.
  Nach der R�ckgabe des Buchs wird die Referenz auf null gesetzt.
  */
  public void bringBackABook(){
    // Implementieren Sie entsprechend dem Sequenzdiagramm den Code
    // die lokale Referenz auf das Buch-Objekt muss "gel�scht" werden. Das...
  ...
  */
  public void remind(){
    // Implementieren Sie entsprechend dem Sequenzdiagramm den Code
    // Der Text " 'name' bringt Buch 'Titel' zur�ck" wird ausgegeben
    //....do it
    String titel = borrowedBook.getTitle();

    System.out.println(name+" bringt Buch "+titel +" zurück");
    bringBackABook();
  }
