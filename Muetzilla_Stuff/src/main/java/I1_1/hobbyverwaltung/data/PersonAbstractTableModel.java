...
/**
 * Die Klasse I1_1.hobbyverwaltung.data.PersonAbstractTableModel erweitert die Klasse AbstractTableModel
 * aus Java-Swing um Funktionalit�ten f�r das Entfernen, Zuf�gen und Sortieren von
 * Objekten der Klasse I1_1.hobbyverwaltung.data.Person.
 * <p>
 * Die Implementation der notwendigen Methoden aus AbstractTableModel
 * erfolgen in der Unterklasse I1_1.hobbyverwaltung.data.PersonenListe.
 *
 * @author Ren� Probst
 * @version 1.0
 * @date 30.12.2014
...
public abstract class PersonAbstractTableModel extends AbstractTableModel {
    ...
    /**
     * Entfernt das durch index markierte I1_1.hobbyverwaltung.data.Person-Objekt aus der Liste der Personen.
     *
    ...
    /**
     * F�gt der Liste der Personen ein neues I1_1.hobbyverwaltung.data.Person-Objekt p zu.
     *
     * @param p I1_1.hobbyverwaltung.data.Person-Objekt das in die Liste eingef�gt wird
     */
