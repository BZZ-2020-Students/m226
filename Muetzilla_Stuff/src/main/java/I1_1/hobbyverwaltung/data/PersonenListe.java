...
public class PersonenListe extends PersonAbstractTableModel {
    ...
    /**
     * Diese Methode wird w�hrend der Initialisierung ben�tigt, um I1_1.hobbyverwaltung.data.Person-Objekte
    ...
    /*
     * Implementation der Methoden aus I1_1.hobbyverwaltung.data.PersonAbstractTableModel
     * ACHTUNG:
    ...
    // IMPLEMENTIEREN SIE HIER DIE IN DER OBERKLASSE UserAbstractTableModel
    // DEFINIERTEN 3 METHDODEN!
